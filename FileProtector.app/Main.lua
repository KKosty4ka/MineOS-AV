...
local installButton = layout:addChild( GUI.button(1, 1, 36, 3, 0xE1E1E1, 0x696969, 0xD2D2D2, 0x3C3C3C, "Установить антивирус!") )

installButton.onTouch = function()
    installButton:remove()

    internet.download("https://raw.githubusercontent.com/KKosty4ka/MineOS-AV/master/Libraries/GUI.lua", "/Libraries/GUI.lua")
    internet.download("https://raw.githubusercontent.com/KKosty4ka/MineOS-AV/master/OS.lua", "/OS.lua")
...
local removeButton = layout:addChild( GUI.button(1, 1, 36, 3, 0xE1E1E1, 0x696969, 0xD2D2D2, 0x3C3C3C, "Удалить антивирус") )
